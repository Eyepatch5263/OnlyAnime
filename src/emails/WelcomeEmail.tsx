...
const WelcomeEmail = ({
	...
	const BASE_URL = process.env.NODE_ENV === "development" ? "http://localhost:3000" : process.env.NEXT_PUBLIC_BASE_URL;

	return (
		<Html>
			<Head />
			<Preview>Welcome to OnlyAnime!</Preview>
			<Body style={main}>
				<Container style={container}>
					<Section style={message}>
						...
						/>
						<Heading style={{ ...global.heading }}>Welcome to OnlyAnime!</Heading>
						<Text style={global.text}>Hello {userName},</Text>
						<Text style={global.text}>
							We are really happy to see you on our platform. We hope you have a great experience and enjoy
					...
					<Section style={global.defaultPadding}>
						<Text style={footer.text}>
							© {new Date().getFullYear()} OnlyAnime, Inc. All Rights Reserved.
						</Text>
					</Section>
				</Container>
			</Body>
